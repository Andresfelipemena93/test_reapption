...
asyncReadFile("./datos.txt").then((arrSplit) => { //En esta parte se cambia el archivo para ser leído.
  ...
  function inRange(day1, day2) {
    ...
    if (conditionI.getTime() <= date2.getTime() && conditionS.getTime() >= date2.getTime()) {
